...
export default function ContactSection() {
    return (
        <section className="bg-[#FDF8F5] py-20 px-6 md:px-16 lg:px-24">
            <div className="mx-auto max-w-6xl flex flex-col md:flex-row items-center justify-between gap-12 md:gap-20">
                ...
                >
                    {/* Sarlavha */}
                    <h2 className="font-serif text-5xl md:text-6xl text-[#5D4037] mb-14 italic tracking-tight uppercase">
                        Contact Us
                    </h2>
