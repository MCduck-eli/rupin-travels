        ...
        <section className="bg-white px-6 py-20 md:px-16 lg:px-24">
            <div className="mx-auto max-w-6xl w-full">
                <div className="relative grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-0">
                    ...
                    >
                        <h2 className="text-4xl md:text-5xl text-[#59493b] uppercase tracking-wider">
                            Our Mission
                        </h2>

                        <div className="text-[17px] md:text-[19px] leading-[1.7] text-[#59493b] space-y-6 font-light">
                            <p>
